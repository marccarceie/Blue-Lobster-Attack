...
intro()
pygame.mixer.music.load('BLA!/music/Toccata & Fugue D Minor, BWV 565.mp3')
...
bullet1=bullet.Bullet("assets/bullet_vertical.jpg",random.randint(200,500-64),200,32,54)
bullet2=bullet.Bullet("assets/bullet_horizontal.jpg",200,random.randint(200,500-64),32,54)
